...
PROJECTS = {
    ...
    "JBCON": {
        ...
        # client-facing pages IN THE ORDER B&C wants them: Summary Billing Report,
        # Invoice, Labor Summary, Work Summary.
        "client_sheets": ["3-Summary Billing Report", "1-Invoice Cover Sheet",
                          "4a-Labor Summary", "2-Work Summary"],
